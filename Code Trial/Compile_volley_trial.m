function [SjX_all_gyro,SjY_all_gyro,SjZ_all_gyro,SjX_all_accel,SjY_all_accel,SjZ_all_accel,SjX_all_grav,SjY_all_grav,SjZ_all_grav] = Compile_volley_trial(files, M, colaccX,colaccY,colaccZ,colgyroX,colgyroY,colgyroZ,colgravX,colgravY,colgravZ)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
% iteratively add a file and concatenate the arrays 
% input of the compile function will be a list of files 
[AllfGyroX,AllfGyroY,AllfGyroZ,DfGyroTime]= segment_gyro_volley_trial(files(1),colaccX,colaccY,colaccZ,colgyroX,colgyroY,colgyroZ);
[AllfGravX,AllfGravY,AllfGravZ,DfGravTime]= segment_gyro_volley_trial(files(1), colaccX,colaccY,colaccZ,colgravX,colgravY,colgravZ);
[AllfAccelX,AllfAccelY,AllfAccelZ,DfAccelTime]= segment_accel_volley_trial(files(1),colaccX,colaccY,colaccZ);

% M = 32;

for i=2:length(files)
    [DfGyroX,DfGyroY,DfGyroZ,DfGyroTime]= segment_gyro_volley_trial(files(i),colaccX,colaccY,colaccZ,colgyroX,colgyroY,colgyroZ);
    [DfGravX,DfGravY,DfGravZ,DfGravTime]= segment_gyro_volley_trial(files(i), colaccX,colaccY,colaccZ,colgravX,colgravY,colgravZ);
    [DfAccelX,DfAccelY,DfAccelZ,DfAccelTime]= segment_accel_volley_trial(files(i),colaccX,colaccY,colaccZ);
...
% ylabel('Acceleration (g)','FontSize',20); %y-asix label
% set(gca,'FontSize',20)
% hold off
% %
% figure
...
% ylabel('Gravity (g)','FontSize',20); %y-asix label
% ylim([-5,5])
% set(gca,'FontSize',20)
% hold off
end