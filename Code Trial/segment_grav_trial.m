function [SignalX,SignalY,SignalZ,SignalTime] = segment_grav_trial(Filename,colaccX,colaccY,colaccZ,colgravX,colgravY,colgravZ)
...
fgyroX = A{1:height(A)-1,colgravX}; %for my data 10, Jake 4
fgyroY = A{1:height(A)-1,colgravY}; %for my data 11, Jake 5
fgyroZ = A{1:height(A)-1,colgravZ}; %for my data 12, Jake 6
...
[bpks,blocs] = findpeaks(faccMovav,'MinPeakProminence',2,'MinPeakDistance',20,'MinPeakHeight',5); %was 5
% for volley
